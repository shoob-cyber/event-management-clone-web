...
def generate_features(service_title):
    ...
    for i, (icon, title, desc) in enumerate(features_data):
        features_html += f'''                <div class="feature-box fade-in-up" style="animation-delay: {0.1 * (i + 1)}s;">
...
'''
    ...
    return features_html.rstrip()

def generate_portfolio(image_folder):
    images = [
        ('475159695_1097850219043563_871709032766323656_n.webp', 'Event Showcase 1', 'Event 1'),
        ('474687434_1095392799289305_5414725815205043615_n.webp', 'Event Showcase 2', 'Event 2'),
        ('474704237_1095392699289315_5300054725633379556_n.webp', 'Event Showcase 3', 'Event 3'),
        ('475371625_1097849975710254_5933682938701390008_n.webp', 'Event Showcase 4', 'Event 4'),
    ]
    
    portfolio_html = ''
    for i, (img, alt, title) in enumerate(images):
        portfolio_html += f'''                <div class="portfolio-item fade-in-up stagger-{(i % 5) + 1} tilt-on-hover lightbox-trigger" data-alt="{alt}" style="animation-delay: {0.1 * (i + 1)}s;">
                    <img src="./assets/images/{image_folder}/{img}" alt="{alt}" class="portfolio-item-image" loading="lazy">
                    <div class="portfolio-item-overlay">
                        <div class="portfolio-item-info">
                            <h3>{title}</h3>
                            <p><i class="fas fa-search-plus"></i> {image_folder}</p>
                        </div>
                    </div>
                </div>
'''
    
    return portfolio_html.rstrip()
...
<head>
    ...
    <title>{config['title']} Services in Muzaffarpur | AR Events & Wedding Planner</title>
    
    <!-- SEO Meta Tags -->
    <meta name="description" content="Professional {config['title_lower']} services in Muzaffarpur, Bihar. Complete event management and planning. Make your {config['title_lower']} unforgettable with AR Events.">
    <meta name="keywords" content="{config['keywords']}">
    <meta name="theme-color" content="#D19C4A">
    
    <!-- Open Graph -->
    <meta property="og:type" content="website">
    <meta property="og:title" content="{config['title']} Services - AR Events & Wedding Planner">
    <meta property="og:description" content="Professional {config['title_lower']} planning & management in Muzaffarpur, Bihar">
...
<body>
    ...
    <section class="hero hero-service">
        ...
        <div class="hero-content">
            <h1 class="fade-in-up">{config['title']}</h1>
            ...
            <div class="hero-cta-group">
                <a href="book.html" class="btn btn-primary">
                    <i class="fas fa-calendar-check"></i> Plan Your {config['title']}
                </a>
    ...
    <section class="container" style="padding: var(--space-3xl) var(--space-lg);">
        <div class="story" style="animation: fadeInUp 0.8s ease-out;">
            <div class="story-content fade-in-left">
                <h2 data-animate="fade-in-left">{config['heading']}</h2>
                <p>
                    {config['intro']}
                </p>
                <p>
            ...
            <div class="story-image fade-in-right image-depth overlay-dark" data-parallax>
                <img src="./assets/images/{config['image_folder']}/{config['image']}" alt="{config['title']}" loading="lazy">
            </div>
        </div>
    </section>
    ...
    <section style="background-color: var(--bg-light); padding: var(--space-3xl) var(--space-lg);">
        <div class="container">
            ...
            <p style="text-align: center; color: var(--secondary-gray); margin-bottom: var(--space-2xl); max-width: 700px; margin-left: auto; margin-right: auto;">
                Comprehensive {config['title_lower']} services designed to bring your vision to life.
            </p>

            <div class="features-grid">
{generate_features(config['title'])}
            </div>
        </div>
    </section>
    ...
    <section style="background-color: var(--bg-light); padding: var(--space-3xl) var(--space-lg);">
        <div class="container">
            <h2 class="fade-in-up" style="text-align: center; margin-bottom: var(--space-xl);">Our {config['gallery_title']} Collections</h2>
            <p style="text-align: center; color: var(--secondary-gray); margin-bottom: var(--space-2xl); max-width: 700px; margin-left: auto; margin-right: auto;">
                Beautiful moments from memorable celebrations we've created.
            </p>

            <div class="portfolio-grid" style="margin-bottom: var(--space-2xl);">
{generate_portfolio(config['image_folder'])}
            </div>
        </div>
    </section>
    ...
    <section style="padding: var(--space-3xl) var(--space-lg);">
        <div class="container">
            <div style="background: linear-gradient(135deg, rgba(209, 156, 74, 0.1) 0%, rgba(81, 81, 82, 0.05) 100%); border: 1px solid rgba(209, 156, 74, 0.2); border-radius: var(--radius-2xl); padding: var(--space-3xl); text-align: center;">
                <h2 style="margin-bottom: var(--space-lg); color: var(--text-dark);">Ready to Plan Your Perfect {config['title']}?</h2>
    ...
    {{
        ...
        "description": "Professional {config['title_lower']} planning and event management services",
        "address": {{
            "@type": "PostalAddress",
